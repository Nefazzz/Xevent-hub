...
ImageButton1.Image = "rbxassetid://16826315208"
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://16826315208"
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://16826315208"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16826315208"
...
local Library = Update:Window("XeventI HUB v2","",Enum.KeyCode.RightControl);
...
local V = Library:AddTab("Sea Event","11156061121")
...
H:AddLabel("Mobile:")
H:AddLabel("Fluxus, DeltaX, Codex, Hydrogen,Arceux")

H:AddSeperator("Developer")

H:AddLabel("Code By Xevent")
H:AddLabel("Best friend: Heiskso")

H:AddLabel("Xevent Hub Discord")
H:AddLabel("https://discord.com/invite/QbRkknyxS5")
...
local Sanguine_Art = H:AddLabel("❌: Sanguine Art")
...
task.spawn(function()
	while wait() do
       ...
       Main:AddToggle("Auto Use Race V4",false,function(value)
...
if _G.ChestBypass then
        ...
        local ohString2 = "Marine"
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(ohString1, ohString2)
     end
end
end)

Main:AddToggle("Auto Stop when get strange items",_G.STP,function(vu)
	Grab_Chest = vu
...
RaceV4:AddButton("Teleport To Pull Lever",function()
...
RaceV4:AddToggle("Auto Buy Gear (Must Have Enough Fragment)",_G.Auto_Farm_Bone4,function(value)
...
RaceV4:AddToggle("Disabled Inf Stairs", nil, function(value)
  ...
  RaceV4:AddToggle("Auto Trial (Must enter the door)",false,function(v)
  _G.AutoQuestRace = v
...
spawn(function()
  ...
  RaceV4:AddButton("Buy Ancient One Quest (Must have Fragment)",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
    ...
    V:AddSeperator("Sea Event")
    
    V:AddLabel("Coming Soon hehe")
...
S:AddToggle("Auto Buy All Abilities", false, function(t)
    Abilities = t
