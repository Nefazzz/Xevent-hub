...
H:AddLabel("ðŸŒ Xevent")
H:AddLabel("ðŸŽ² https://discord.com/invite/36w4UXkXzc")

H:AddLabel("WORKING ALL EXECUTOR! âœ… ")
H:AddLabel("XEVENT HUB MAJU ðŸ˜Ž ")
...
local kataJackpot = {"Xevent Ganteng"}
...
if teks == nil or foundTerlarang then
    game:GetService("Players").LocalPlayer:Kick("U Get Kicked From ME !!\n Reason : Spam / Troll / Toxic, For Suggestion!")
...
task.spawn(function()
	while wait() do
       ...
       Main:AddToggle("Auto Turn On V4 Race",false,function(value)
...
Main:AddToggle("Farm Chest Bypass | Risk Banned",false,function(vu)
	_G.ChestBypass = vu
end)
...
_G.BringMode = "Normal"
Main:AddDropdown("Bring Mob Mode (beta)", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
RaceV4:AddLabel("IND: Harus Di Thirdsea oy ðŸ˜")
    ...
    T:AddButton("Bypass Teleport",function()
		 if _G.TeleportWarp == "Manslon" then
		        ...
		        elseif _G.SelectWarp == "Tiki Outpost" then
                    ...
                    game.Players.LocalPlayer.Character.Head:Destroy()
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
                elseif _G.SelectWarp == "Secret Temple" then
					wait(.1)
...
Misc:AddSeperator("Teams")
    ...
    Misc:AddButton("Translate All Bahasa To Indonesia ",function()
...
properties.Text = "[Xevent] : Semua Chat Yang Bahasa Bukan Indonesia Akan Otomatis Translate Ke Indonesia!"
properties.Text = "[Xevent] : Jika Mau Mengganti Ke Babasa Inggris Ketik [ >en ] Di Chat"
...
properties.Text = "[Xevent] : Semua Chat Yang Bahasa Bukan Indonesia Akan Otomatis Translate Ke Indonesia!"
properties.Text = "[Xevent] : Jika Mau Mengganti Ke Bahasa Inggris Ketik [ >en ] Di Chat"
StarterGui:SetCore("ChatMakeSystemMessage", properties)
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "";
      Title = "Xevent", 
      Text = "https://discord.com/invite/36w4UXkXzc";
})
end
...
local function animateLoadingBar()
    ...
    while true do
        ...
        elseif checkIdPlayer then
            ...
            local borderWidth = 2  -- Width of the white border
            ...
            createTextLabel("Text1", "Uh i get blocked", 0.2)
            createTextLabel("Text2", "Join Discord Xevent Hub", 0.5)
            createTextLabel("Text3", "https://discord.com/invite/36w4UXkXzc", 0.8)
            WebhookScan()
